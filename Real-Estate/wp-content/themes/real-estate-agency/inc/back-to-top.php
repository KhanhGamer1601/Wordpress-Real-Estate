...
function real_estate_agency_back_to_top_customize_register( $wp_customize ) {
...
***********************************************************************************/
		...
		$wp_customize->add_section( 'back_to_top' , array(
			'title'       => __( 'Back To Top Button Options', 'real-estate-agency' ),
			'priority'   => 98,
		) );
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'activate_back_to_top', array(
			'label'    => __( 'Activate Back To Top Button', 'real-estate-agency' ),
			'section'  => 'back_to_top',
		...
		'label' => __('Button Color', 'real-estate-agency'),        
		'section' => 'back_to_top',
		...
		'label' => __('Button Hover Color', 'real-estate-agency'),        
		'section' => 'back_to_top',
		...
		'label' => __('Button Background Color', 'real-estate-agency'),        
		'section' => 'back_to_top',
		...
		'label' => __('Button Background Hover Color', 'real-estate-agency'),        
		'section' => 'back_to_top',
		'settings' => 'back_button_background_hover_color'
		) ) );
}
add_action( 'customize_register', 'real_estate_agency_back_to_top_customize_register' );

/********************************************
* Back to top styles
*********************************************/ 	

function real_estate_agency_back_top_method() {
...
add_action( 'wp_enqueue_scripts', 'real_estate_agency_back_top_method' );		
...
function real_estate_agency_to_top() {
    echo '<a id="totop" href="#"><span class="dashicons dashicons-arrow-up-alt2"></span></a>';
    }

    add_action( 'wp_head', 'real_estate_agency_back_to_top_style' );
    function real_estate_agency_back_to_top_style() {
    echo '<style>
    #totop {
		position: fixed;
		right: 40px;
