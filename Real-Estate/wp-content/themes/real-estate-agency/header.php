...
<?php if ( function_exists( 'wp_body_open' ) ) { wp_body_open(); } else { do_action( 'wp_body_open' ); } ?>
		<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'real-estate-agency' ); ?></a>
		<?php real_estate_agency_header (); ?><!-- Go to /inc/header-top.php -->	
