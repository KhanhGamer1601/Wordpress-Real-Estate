	...
	<header class="entry-header">
		...
		if ( 'post' === get_post_type() ) :
			...
			<div class="entry-meta">
				<?php
				real_estate_agency_posted_on();
				real_estate_agency_posted_by();
				?>
			</div><!-- .entry-meta -->
		<?php endif; ?>
	</header><!-- .entry-header -->
	...
	<div class="entry-content">
		...
		the_content( sprintf(
			wp_kses(
				...
				__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'real-estate-agency' ),
				array(
					'span' => array(
						'class' => array(),
					),
		...
		wp_link_pages( array(
			'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'real-estate-agency' ),
			'after'  => '</div>',
		) );
		?>
	</div><!-- .entry-content -->
<?php endif; ?>
	<footer class="entry-footer">
		<?php real_estate_agency_entry_footer(); ?>
	</footer><!-- .entry-footer -->
